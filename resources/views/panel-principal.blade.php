...
@section('content')
<nav style="--falcon-breadcrumb-divider: '»';" aria-label="breadcrumb" class="mb-2">
    <ol class="breadcrumb">
    ...
    <div class="col-sm-6 col-lg-4 mb-4">
        <div class="card overflow-hidden" style="width: 20rem;">
            ...
            <div class="card-body">
                ...
                <p>
                    <a class="btn btn-falcon-default mt-2" data-bs-toggle="collapse"
                        href="#collapseOrientacionEducativa" role="button" aria-expanded="false"
                        aria-controls="collapseExample">Módulos</a>
                </p>
