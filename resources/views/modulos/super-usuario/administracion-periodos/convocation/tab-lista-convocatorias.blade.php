      ...
      <div class="row flex-between-end">
        ...
        <div class="col-6 col-sm-auto ms-auto text-end ps-0">
          <div id="table-purchases-replace-element">
            <button class="btn btn-falcon-default btn-sm" role="button" data-bs-toggle="modal" data-bs-target="#nueva-convocatoria-modal">
            ...
            <div class="modal fade" id="nueva-convocatoria-modal" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-content position-relative">
                  ...
                  <div class="modal-body p-0">
                    <div class="rounded-top-lg py-3 ps-4 pe-6 bg-light">
                      <h4 class="mb-1" id="modalExampleDemoLabel"> Registrar nueva convocatoria </h4>
                    </div>
