            ...
            <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                <thead class="bg-200 text-1000">
                    <tr>
                        ...
                        <th class="sort pe-1 align-middle white-space-nowrap pe-4" data-sort="order">Estudiantes</th>
                        <th class="sort pe-1 align-middle white-space-nowrap pe-7" data-sort="order">Desarrollo Humano</th>
                        <th class="sort pe-1 align-middle white-space-nowrap pe-7" data-sort="order">Física/Estadística</th>
                        ...
                        <th class="sort pe-1 align-middle white-space-nowrap pe-7" data-sort="order">Proyecto</th>
                        <th class="sort pe-1 align-middle white-space-nowrap pe-6" data-sort="order">Estado</th>
                ...
                <tbody class="list" id="table-orders-body">
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="estudiantes py-2 align-middle white-space-nowrap">30</td>
                        <td class="desarrollo-humano py-2 align-middle white-space-nowrap">Jose Rodríguez</td>
                        <td class="fisica/estadistica py-2 align-middle white-space-nowrap">Marta Jiménez</td>
                        <td class="ingles py-2 align-middle white-space-nowrap">Rebeca García</td>
                        <td class="matematicas py-2 align-middle white-space-nowrap">Juan López</td>
                        <td class="proyecto py-2 align-middle white-space-nowrap">Rebeca García</td>
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="estudiantes py-2 align-middle white-space-nowrap">27</td>
                        <td class="desarrollo-humnano py-2 align-middle white-space-nowrap">Juan López</td>
                        <td class="fisica/estadistica py-2 align-middle white-space-nowrap"></td>
                        <td class="ingles py-2 align-middle white-space-nowrap">Rebeca García</td>
                        <td class="matematicas py-2 align-middle white-space-nowrap">Juan López</td>
                        <td class="proyecto py-2 align-middle white-space-nowrap">Rebeca García</td>
                        <td class="estatus py-2 align-middle text-center fs-0 white-space-nowrap">
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="fisica/estadistica py-2 align-middle white-space-nowrap">Juan López</td>
                        <td class="ingles py-2 align-middle white-space-nowrap">Rebeca García</td>
                        <td class="matematica py-2 align-middle white-space-nowrap"></td>
                        <td class="proyecto py-2 align-middle white-space-nowrap"></td>
                        <td class="estatus py-2 align-middle text-center fs-0 white-space-nowrap">
                            <span class="badge badge rounded-pill d-block badge-soft-primary">Asignando
                                <span class="ms-1 fas fa-stream" data-fa-transform="shrink-2"></span>
                            </span>
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="estudiantes py-2 align-middle white-space-nowrap">29</td>
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="estudiantes py-2 align-middle white-space-nowrap">37</td>
                        <td class="desarrollo-humnano py-2 align-middle white-space-nowrap"></td>
                        <td class="fisica/estadistica py-2 align-middle white-space-nowrap"></td>
                        <td class="ingles py-2 align-middle white-space-nowrap"></td>
                        <td class="matematicas py-2 align-middle white-space-nowrap"></td>
