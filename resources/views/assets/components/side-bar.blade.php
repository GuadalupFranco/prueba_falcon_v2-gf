    ...
    <div class="d-flex align-items-center">
        <div class="toggle-icon-wrapper">
            ...
            <div class="d-flex align-items-center py-3"><img class="me-2"
                    src="/UPQ-logo.svg" alt="" width="40"><span
                    class="font-sans-serif">SIIUPQ</span>
            </div>
        </a>
    </div>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link dropdown-indicator" href="#dashboard" role="button"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="nav-link-text ps-1">Administrador</span>
                        </div>
                    </a>
                    <ul class="nav collapse show" id="dashboard">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('administrador-roles.index') }}" aria-expanded="false">
                                <div class="d-flex align-items-center">
