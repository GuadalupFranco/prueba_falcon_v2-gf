            ...
            <td class="name text-nowrap w-25">
              <div class="d-flex align-items-center">
                <div class="avatar" style="width: 7rem;">
                  <img class="rounded-3" src="../../assets/img/team/120035275.jpg" alt="" />
                </div>
                <div class="ms-4">Andrés Javier Camacho Ledezma</div>
              </div>
            </td>
              <!-- CURP -->
              ...
              <div class="d-flex mb-3 flex-column">
                <div class="p-2">
                    ...
                    <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#curp">
                      <span class="fas fa-file-pdf text-success fs-5"></span>
                    </button>
          ...
          <tr>
            ...
            <td class="align-middle text-center">
              ...
              <div class="p-2 bd-highlight">
                      ...
                      <!-- Button trigger modal -->
                  <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#curp">
                    <span class="fas fa-file-pdf text-danger fs-5"></span>
                  </button>
