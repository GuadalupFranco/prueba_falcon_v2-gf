<div class="tab-pane fade show active" id="tab-home" role="tabpanel" aria-labelledby="apartado-permisos">
    <div class="card mb-3">
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor" id="pagination-with-numbering">Permisos</h5>
                </div>
            </div>
            <div class="col-12 ms-auto">
                <button class="btn btn-info btn-sm m-auto float-end text-uppercase" type="button">
