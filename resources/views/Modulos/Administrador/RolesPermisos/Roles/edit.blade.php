    ...
    <div class="card-body bg-light">
        <div class="tab-content">
            <div class="tab-pane preview-tab-pane active" role="tabpanel"
                ...
                <form action="{{ route('administrador-roles.update', $role -> id) }}" method="POST" enctype="multipart/form-data" id="form-modificar">
                    @csrf
                    @method('PUT')
                    <div class="py-0 p-4">
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-check">
                                        ...
                                        class="form-check-input" id="permiso-{{ $permiso -> id }}" type="checkbox"
